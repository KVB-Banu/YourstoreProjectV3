...
public class LoginSignup extends LoginDetails {
...
//					System.out.println(driver.switchTo().window(child_window).getTitle());
					...
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
							"//div[@class='signup-card']/child::app-signup/descendant::form/descendant::input[@name='store_name']")));
					...
					Select s5 = new Select(driver.findElement(By.name("category")));
					s5.selectByVisibleText("Clothing");
...
//			    	s6.selectByIndex(2);
					...
					wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
							"//div[@class='signup-card']/child::app-signup/descendant::form/child::div/child::div[2]/descendant::textarea")));
