...
public class NegativeTC extends LoginDetails{
	...
	static String cfm_password = "dinesh";
	...
	public void signinNegativeTC() throws InterruptedException {
		Actions ac = new Actions(driver);
	try {
	...
	public void placingOrder() throws InterruptedException
	{
		...
		Thread.sleep(2000);
			...
			if(cusYourGarment.isEnabled())
			{
				...
				System.out.println("Error : " + driver.findElement(By.cssSelector("div[class='alert-msg d-flex align-items-center justify-content-center p-2'] p[class='m-0']")).getText());
				File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(screenshot, new File("C:\\Users\\white\\OneDrive\\Documents\\ScreenShots\\cust.error.png"));
				driver.findElement(By.name("name")).sendKeys("Model01");
				driver.findElement(By.xpath("//button[normalize-space()='NEXT']")).click();
				driver.findElement(By.id("notes_name0")).sendKeys("");
				driver.findElement(By.xpath("//button[normalize-space()='SUBMIT']")).click();
				File screenshot1 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(screenshot1, new File("C:\\Users\\white\\OneDrive\\Documents\\ScreenShots\\cust.error1.png"));
